...
export const usePermissionStore = defineStore('permissions', () => {
  ...
  const permissions = ref({
    ...
    MANAGER: ['dashboard', 'announcements', 'messenger', 'stores', 'inventory', 'sales', 'pos-support', 'promotions', 'tracking', 'customer-analytics', 'pos-health', 'drivers', 'products', 'warehouse-inventory', 'purchase-orders', 'coupons', 'pos-management'],
    BRANCH_MANAGER: ['dashboard', 'announcements', 'messenger', 'my-store', 'pos-management', 'inventory', 'sales', 'pos-support', 'purchase-orders'],
  });
